...
@section('content')
    ...
    <div class="container">
        <div class="jumbotron mt-3" style="padding-top: 0; margin-top:0;">
            ...
            {{ Form::model('Naryads', array('url' => array('orders/'.$naryadRecord['order_id'].'/editpart2'), 'method' => 'POST')) }}
            ...
            <div class="text-lg-left">
                <div class="row">
                    ...
                    <div class="col-md-6"><h3 style="font-size: 14pt;">АТ "ANYОБЛЕНЕРГО" {{'mode='.$mode}}</h3></div>
                </div>
                <div class="row">
