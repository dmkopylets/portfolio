...
<div class="relative flex items-top justify-center min-h-screen  sm:items-center sm:pt-0">
   <div class="input-group" style="padding-top: 0; margin-top:0; margin-bottom: 10px; display: flex; text-align:left; ">
      ...
      <button type="submit" 
         ...
         formaction="{{url('naryads/'.$naryadRecord['order_id'].'/reedit4')}}"
         formmethod="post">
         <i class="fa fa-arrow-circle-o-left" aria-hidden="true"></i> назад
      </button> 

   <div class="container jumbotron mt-3" style="padding-top: 2; margin-left:13px; margin-top:0;  margin-bottom:5px;">    
  ...
  <div  style="float: center; margin-right: 1px;">
   <button type="submit" 
    ...
    formmethod="post">
    <i class="fa fa-save fa-fw" aria-hidden="true"></i> Зберегти ВСЕ!!! </button>
 </div>
