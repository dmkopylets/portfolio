...
<div class="container">
    <h2><strong>Groups list</strong></h2>
                   ...
                   @endforeach
                    <th class="col-xs-2" width="275px">
                          <div style="float: right; margin-right: 5px;">
                            ...
                            <a href="{{ URL::to('groups/create') }}" class="btn btn-small btn-outline-info" ><i class="fa fa-plus" aria-hidden="true"></i> New group</a>
                        </div>
                    </th>
                </tr>
              </thead>
                    ...
                    <tr>
                       ...
                       <td class="col-xs-2 flex">
                        <div style="float: right; margin-right: 2px;">
                           <a href="{{asset('/').'groups/'.$record->id.'/edit'}}" class="btn btn-outline-info btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> edit</a>&nbsp&nbsp
                           <a href="{{asset('/').'groups/'.$record->id.'/destroy'}}" class="btn btn-outline-danger btn-sm"><i class="fa fa-trash-o fa-lg" aria-hidden="true"></i> delete</a>
                        </div>
                       </td>
                    </tr>
                @endforeach
